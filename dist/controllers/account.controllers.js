...
let AccountControllers = class AccountControllers {
    service;
    constructor(service) {
    ...
    create = async (req, res) => {
        ...
        return res.status(httpStatusCode_1.status.HTTP_201_CREATED).json(account);
    };
    list = async (req, res) => {
        const accounts = await this.service.list();
        return res.status(httpStatusCode_1.status.HTTP_200_OK).json(accounts);
    };
...
exports.AccountControllers = AccountControllers = __decorate([
